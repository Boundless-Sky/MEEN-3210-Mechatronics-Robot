/**************************************************************************************
 Remote Control
 Team: Jusitn Ngo, Dalton Ostler, Scott Ferguson, Matthew Burns
...
/*
 ...
 - Added a delay to transmission
 
 Version 3 (Justin Ngo - April 7, 2016)
 - Removed stop bit
 - mapped inputs to 254
 - removed sending grip data
 */
/**************************************************************************************
 Hardware Hookup:
 ...
 ***************************************************************************************/
void sendData() {
  byte sendX = map(X, 0, 1023, 0, 254);
  byte sendY = map(Y, 0, 1023, 0, 254);
  byte sendArm = map(Arm, 0, 1023, 0, 122); //Max Motion the arm can go
