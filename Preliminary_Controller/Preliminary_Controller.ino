// Justin Ngo, Dalton Ostler, Matthew Burns, Scott Furgenson
// ME EN 3210: Milestone 2 Controller
// Note: Buttons are not necessary for our robot design. Potentiometers are the key factors. 
...
int potAnalogPinGrip = 4;
int potAnalogPinArm = 5;
...
void setup() {
  ...
  pinMode(potAnalogPinGrip, INPUT);
  pinMode(potAnalogPinArm, INPUT);

  // Sets pin 12 and 13 as output and turns on LED
...
void loop() {
  ...
  // buttons, Potentiometer) to the console.
  Serial.print("l:");
  ...
  Serial.print("Pot Grip:");
  Serial.print(analogRead(potAnalogPinGrip));
  Serial.print(" ");

  Serial.print("Pot Arm:");
  Serial.print(analogRead(potAnalogPinArm));
  Serial.print(" ");
